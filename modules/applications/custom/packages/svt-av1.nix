...
stdenv.mkDerivation (finalAttrs: {
  pname = "svt-av1-${finalAttrs.version}";
  version = "4.1.0";
  ...
  postInstall = ''
    wrapProgram $out/bin/SvtAv1EncApp \
      --set SVT_AV1_VERSION ${finalAttrs.version}

    mv $out/bin/SvtAv1EncApp $out/bin/svt-av1-${finalAttrs.version}
  '';
