...
in
{
    ...
    services = lib.mkOption {
      ...
      type = lib.types.attrsOf (lib.types.submodule {
        options = {
          ...
          envVars = lib.mkOption { type = lib.types.attrsOf lib.types.str; default = {}; };
        };
      });
    };
  };
  ...
  config = {
    ...
    networking.firewall.allowedUDPPorts = lib.flatten (lib.mapAttrsToList (name: value: value.ports) cfg.services);
  };
}